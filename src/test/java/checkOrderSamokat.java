...
//        driver = new FirefoxDriver();
    ...
    private final String whereOrder;
    ...
    public checkOrderSamokat(String whereOrder, String firstName, String secondName, String adress, String metroStation, String phoneNumber, String date, String samokatColor, String commentForCourier) {
    ...
    public static Object[][] getCredentials() {
        return new Object[][]{
                {"up", "Иван", "Иванов", "ул. Пушкина", "Черкизовская", "+71111111111", "27.08.2023", "black", ""},
                {"down", "Мария", "Иванова", "ул. Твердая", "Лубянка", "88888888888", "30.08.2023", "grey", "Перед выездом позвонить мне!"},
        };
    }
